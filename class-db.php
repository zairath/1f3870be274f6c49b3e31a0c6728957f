...
class DB {
    ...
    public function insert_email($email, $subject, $html) {
        $this->db->query("INSERT INTO sent_emails(to_email, subject, html) VALUES('$email', '$subject', '$html')");
    }
}